...
export function mutationAuthority(engine: RuntimeConfigLookup, ownerUserId: string, existing: BotConfig | undefined, id: string | undefined, requestedExchange: ExchangeId): { runtime?: BotConfig; role: AuthRole; secureOrigin: boolean } {
  const runtime = id ? engine.runtimeConfigForOwner(ownerUserId, id) : undefined;
