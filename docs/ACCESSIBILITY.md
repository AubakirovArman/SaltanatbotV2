...
| --- | --- | --- |
| Keyboard-only operation | Native controls, global shortcuts, focusable scrolling chart-data region, price-chart settings disclosures, resizable panel separator keys and modal focus containment | Playwright command, chart-data, price-based settings/axe, resize, wizard and focus-return scenarios |
