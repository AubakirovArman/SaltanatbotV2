...
```
candles  hollow  heikin  bars  line  step  area  baseline  renko  linebreak  kagi
```
...
```json
{
  ...
  "chartTypes": ["candles", "hollow", "heikin", "bars", "line", "step", "area", "baseline", "renko", "linebreak", "kagi"]
}
```
