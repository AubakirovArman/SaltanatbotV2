...
- Reviewed installed-desktop file opening for exact Pine, strategy and plugin formats with cross-browser manual fallbacks.
...
| PWA file interoperability | Offline research, safe shortcuts and reviewed OS file handlers are delivered; an optional reviewed Share Target remains | S–M |
