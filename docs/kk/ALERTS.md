...
[Telegram paper командалары](#telegram-paper-командалары-r53b-2-жұмыс-барысында)
бөлімінде сипатталған, жұмыс барысындағы R5.3b-2 инкременті.
...
## Telegram paper командалары (R5.3b-2, жұмыс барысында)

R5.3b-2 байланыстырылған приват чатты оқу командаларымен және paper
роботтарды екі қадамдық fenced басқарумен кеңейтеді. Инкремент **жұмыс
барысында, қабылданбаған**: кандидат 16-миграция `telegram_command_bridge`
`telegram_command_replies` және `telegram_confirmations` кестелерін қосады,
production cutover орындалған жоқ. Worker бұрынғыдай HTTP listener ашпайды
