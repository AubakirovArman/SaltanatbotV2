...
recovery күйін, прогондар тізімін және append-only оқиғаларды көрсетеді. Қазір screener нәтижесін бір
батырмамен беру емес, зерттеу қозғалтқышының дәл жоспарын енгізу керек. Модульде private exchange
client жоқ, credentials қабылдамайды, public SDK-ға кірмейді және нақты order тізбегін орындамайды
немесе бүкіл биржаға арналған live scanner болып саналмайды.
