...
- Indicator және compare editor негізгі chart-та бір рет қана көрсетіледі және ағымдағы модельдегі барлық pane-ге қолданылады; secondary pane duplicate control көрсетпейді. `UTC · STRUCT` карточкасы барлық chart-та бастапқыда collapsed: VWAP, session, BOS/CHOCH/FVG және swing strength ашу үшін click жасаңыз немесе focus беріп `Enter` басыңыз.
