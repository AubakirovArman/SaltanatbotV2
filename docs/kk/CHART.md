...
- Қосымша графиктерде symbol, timeframe, crosshair және visible time range негізгі графикпен бөлек байланысады. Linked zoom/pan absolute UTC boundary жібереді, сондықтан әртүрлі timeframe candle index бойынша drift жасамайды; loaded history-ден тыс range chart-ты секіртпейді.
