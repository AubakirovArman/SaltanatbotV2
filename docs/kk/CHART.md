...
Kagi уақытты қысып, маңызды price movement-ті ғана көрсетеді. Бірінші confirmed price instrument minimum tick-іне дөңгелектелген тұрақты 0,10% reversal threshold береді. Жаңа close-extreme ағымдағы vertical line-ды ұзартады, threshold-тан кіші қарсы қозғалыс filter жасалады. Толық reversal-дан кейін horizontal shoulder немесе waist және қарама-қарсы жаңа vertical line пайда болады. Өсу жасыл, төмендеу қызыл, confirmed endpoint шеңбермен белгіленеді.
