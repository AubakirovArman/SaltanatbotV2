...
Пакет жасау үшін `@saltanatbotv2/plugin-core` ішіндегі `encodePluginFile()`
қолданыңыз, нәтижені `.saltanat-plugin` ретінде сақтап, Strategy Studio ішіндегі
**Плагин** әрекетін таңдаңыз. Import кезінде IDs және dependencies жаңа жергілікті
