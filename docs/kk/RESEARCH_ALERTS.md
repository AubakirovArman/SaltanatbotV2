...
Production енді PostgreSQL schema 13 қолданатын қабылданған әрі deploy жасалған R5.1 релизінде
жұмыс істейді, қорғалған слот r5a-schema13-66394fd
([evidence](../evidence/R5_1_OWNER_ALERTS.md)). Producer-лары қосылмаған бұл контур бұрынғыша
accepted немесе deployed деп саналмайды.
...
семантикасын қолданады. Release gate — browser-closed restart/dedup, same-owner multi-tab
convergence, local-storage failure және desktop/mobile accessibility/visual evidence — production
cutover алдында өтті. R5.2 technical screener, R5.3 notification worker/Telegram және R11
integrated 100-user proof pending әрі дәлелденбеген күйде қалады.
...
Қосылмаған producer integration-дары бөлек жұмыс болып қалады және қабылданған generic R5.1
релизінің статусын мұраламайды.
