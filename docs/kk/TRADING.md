...
### Мүмкіндік зерттеуінен multi-leg paper интенттері (R8, қабылданды)

R8 **қабылданды және өндіріске шықты** — production trading SQLite schema 10-мен жұмыс істейді;
жазылған [R8 acceptance evidence](../evidence/R8_MULTI_LEG_PAPER_INTENTS.md) құжатын қараңыз.
Ол зерттелген мүмкіндіктен paper портфель ішіндегі durable multi-leg paper симуляциясына
дейінгі owner-scoped бір басу жолын қосады:
...
математикасы, лимиттер, қалпына келтіру семантикасы және production-та қолданылған trading
SQLite v10 миграциясы (ағылшынша канондық құжат):
[Canonical paper portfolios](../PAPER_PORTFOLIOS.md). Бұл әрекет төмендегі legacy admin
multi-leg журналынан бөлек; журнал дәл JSON-жоспар импортын өзгеріссіз сақтайды.
...
ағылшынша қолжетімді; бұл журнал тек дәл JSON жоспарын қабылдайды. Жоғарыда сипатталған
қабылданған R8 әрекеті бөлек durable owner-scoped paper интентін жібереді — ол осы журналдың
JSON-жоспарын жасамайды және live ордер орналастыра алмайды.
