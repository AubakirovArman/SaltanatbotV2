...
### Grid робот түрі (R7, жұмыс барысында)

R7 — **жұмыс барысында, қабылданбаған**: ол үшін release gate әлі орындалған жоқ, production әлі
де қабылданған R6 релизінде жұмыс істейді. Жасау формасындағы робот түрін ауыстырғышқа үшінші
