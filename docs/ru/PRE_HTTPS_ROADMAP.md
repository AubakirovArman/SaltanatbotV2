...
Статус: завершён и развёрнут на schema 11; R3.1, R3.2 и R3.3 с соответствующим
срезом O1 приняты. Следующий инкремент — R4. Baseline: PostgreSQL auth,
...
строго последовательный: R4 → R5 → R6 → R7 → R8 → R9 → R10A → R10B → R11 →
