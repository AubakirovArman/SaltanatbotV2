...
Статус: пользовательские документы принятого релиза проверены против версии `0.1.0`; R4 принят и
развёрнут 2026-07-17 из защищённого слота `r4c-schema12-bb455fa` на PostgreSQL schema 12 и trading
SQLite schema 9. Интерфейс полностью типизирован на EN/RU/KK; английская документация остаётся
канонической для точных API-схем и инженерных внутренних контрактов. HTTPS и live/private
исполнение остаются вне текущего `public-http-paper` релиза.
...
- [Канонические paper-портфели принятого R4: lifecycle, upgrade, backup и rollback](PAPER_PORTFOLIOS.md)
