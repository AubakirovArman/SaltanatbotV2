...
Статус: пользовательские документы принятого релиза проверены против версии `0.1.0` 2026-07-14;
R4 paper-portfolio runbook добавлен 2026-07-17 как кандидат, а не cutover claim. Интерфейс
...
- [Канонические paper-портфели: lifecycle, upgrade, backup и rollback кандидата R4](PAPER_PORTFOLIOS.md)
