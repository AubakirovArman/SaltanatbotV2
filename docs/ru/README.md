...
Статус: пользовательские документы проверены против версии `0.1.0` 2026-07-11. Английская
документация остаётся канонической для точных API-схем и инженерных внутренних контрактов.
