...
const en = {
  ...
  loadPineFiles: "Load .pine file(s)", pastedScript: "Pasted script", convert: "Convert", artifact: "artifact", artifacts: "artifacts", add: "Add", converted: "converted", rejected: "rejected", approximations: "Compatibility diagnostics — review before trusting with money:", fidelity: "Fidelity", exact: "exact", approximation: "approximation", displayOnly: "display-only", profile: "profile", sourceLine: "line", remediation: "Action", pineSource: "Pine source", generatedBlocks: "Generated blocks", originalPineSource: "Original import evidence. Editing blocks does not rewrite this Pine source.", someFilesUnreadable: "Some files could not be read.", skippedTooLarge: "skipped (too large)", couldNotRead: "could not be read", skippedMaxFiles: "skipped (file limit)", remove: "Remove"
} as const;
