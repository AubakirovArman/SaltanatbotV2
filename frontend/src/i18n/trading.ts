...
const en = {
  ...
  liveTradingExplanation: "Live trading places real orders with your exchange keys. It is disarmed by default; arm it only when you intend to trade for real. The kill switch stops every bot and disarms instantly.",
  armLiveTrading: "Arm live trading",
  armed: "ARMED",
  killSwitch: "Kill switch — stop all bots",
  killConfirm: "Stop ALL bots and disarm live trading now?",
...
const ru: Record<TradingMessageKey, string> = {
  ...
  liveTradingExplanation: "Реальная торговля размещает ордера через ваши биржевые ключи. По умолчанию она отключена; включайте её только для намеренной торговли. Аварийная остановка немедленно останавливает всех ботов и запрещает live-торговлю.",
  armLiveTrading: "Разрешить реальную торговлю",
  armed: "РАЗРЕШЕНА",
  killSwitch: "Аварийная остановка — остановить всех ботов",
  killConfirm: "Остановить ВСЕХ ботов и запретить реальную торговлю?",
