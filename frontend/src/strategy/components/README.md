...
- `StrategyLibrary.tsx` owns artifact selection, reviewed file import/export, Pine import entry and
  the template gallery. An approved root PWA batch is prepared once here before entering its
  format-specific queue.
- `../../pwa/PwaFileLaunchDialog.tsx` shows the metadata-only installed-app open/share boundary;
