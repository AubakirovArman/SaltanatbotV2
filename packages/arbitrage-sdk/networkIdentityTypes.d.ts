...
export type NetworkTransferFailureCode = "invalid-request" | "registry-version-mismatch" | "unknown-asset" | "unknown-source-mapping" | "ambiguous-source-mapping" | "unknown-destination-mapping" | "ambiguous-destination-mapping" | "identity-reference-invalid" | "identity-evidence-invalid" | "wrapped-asset-unsupported" | "network-asset-mismatch" | "reorg-sensitive-network" | "capability-missing" | "capability-evidence-invalid" | "withdrawal-unavailable" | "deposit-unavailable" | "memo-required" | "memo-unexpected" | "fee-unpriced" | "amount-below-withdrawal-minimum" | "amount-above-withdrawal-maximum" | "amount-after-fee-nonpositive" | "amount-below-deposit-minimum" | "amount-above-deposit-maximum" | "arrival-estimate-timeout" | "arrival-proof-invalid" | "arrival-proof-mismatch" | "arrival-status-unconfirmed" | "arrival-confirmations-insufficient" | "arrival-timeout" | "arrival-amount-invalid";
export interface NetworkTransferCompatibilityResult {
    ...
    evidenceIds: string[];
    failures: Array<{
        code: NetworkTransferFailureCode;
        message: string;
        subject?: string;
    }>;
}
