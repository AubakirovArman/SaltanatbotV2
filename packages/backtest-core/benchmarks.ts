...
import { DEFAULT_BACKTEST_CONFIG, type BacktestConfig, type Trade } from "./types.js";
...
const units = { k: "size", mode: "units", value: { k: "num", v: 1 } } as const;
const always = { k: "bool", v: true } as const;
const entry = { k: "entry", direction: "long", when: always } as const;
...
export const BACKTEST_BENCHMARKS: readonly BacktestBenchmark[] = Object.freeze([
  benchmark({
