...
export type ChartType = "candles" | "hollow" | "heikin" | "bars" | "line" | "step" | "area" | "baseline" | "renko";
...
const chartTypes = new Set<ChartType>(["candles", "hollow", "heikin", "bars", "line", "step", "area", "baseline", "renko"]);
