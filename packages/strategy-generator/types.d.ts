...
export declare const GENERATOR_LIMITS: {
    readonly minPopulation: 2;
    readonly maxPopulation: 128;
    readonly maxGenerations: 32;
    readonly maxCandidates: 2048;
    readonly maxAttemptsPerGeneration: 8192;
    readonly maxMutationLogEntries: 16;
    readonly maxIrInputs: 16;
    readonly maxIrNodes: 160;
};
