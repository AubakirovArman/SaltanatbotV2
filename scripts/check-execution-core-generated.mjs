/** Verify checked-in execution-core runtime artifacts match canonical TypeScript. */
...
try {
  ...
  if (stale.length > 0) {
    console.error(`Generated execution-core artifacts are stale: ${stale.join(", ")}. Run npm run build -w @saltanatbotv2/execution-core.`);
    process.exitCode = 1;
  } else {
    console.log("Execution-core runtime and declarations are current.");
  }
} finally {
